...
public class RailsFamilyFactory extends UpdatesWithNeighboursFamilyFactory {
    ...
    public RailsFamilyFactory() {
        super(new FencesConnectionCondition(), (byte) 0b110110, FENCES_MAPPING, true);
    }

    private static class FencesConnectionCondition implements ConnectionCondition {
        @Override
