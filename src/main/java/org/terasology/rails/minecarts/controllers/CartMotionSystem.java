...
public class CartMotionSystem extends BaseComponentSystem implements UpdateSubscriberSystem {
    ...
    public void onBump(CollideEvent event, EntityRef entity) {
        ...
        else if(event.getOtherEntity().hasComponent(RailVehicleComponent.class))
        {
            ...
            //TODO: replace with manafold normal
            ...
            float jv = ((v1n.x * v1.velocity.x) + (v1n.y * v1.velocity.y) +(v1n.z * v1.velocity.z))-
                       ((v1n.x * v2.velocity.x) + (v1n.y * v2.velocity.y) + (v1n.z * v2.velocity.z));
            if(jv <= 0)
                return;
            ...
            Vector3f r1v = new Vector3f(v1n.x/r1.mass,v1n.y/r1.mass,v1n.z/r1.mass).mul(lambda);
            Vector3f r2v = new Vector3f(v1n.x/r2.mass,v1n.y/r2.mass,v1n.z/r2.mass).mul(lambda);
