...
public class MinecartAction extends BaseComponentSystem {
    ...
    public void onPlayerSpawn(OnPlayerSpawnedEvent event, EntityRef player, InventoryComponent inventory) {
        ...
        inventoryManager.giveItem(player, player, entityManager.create("Minecarts:minecart"));
        inventoryManager.giveItem(player, player, entityManager.create("Minecarts:wrench"));
        inventoryManager.giveItem(player, player, blockFactory.newInstance(blockManager.getBlockFamily("Minecarts:rails"), 99));
    }
